                    ...
                    <div id="accordion-filter-price" class="accordion-collapse collapse show border-0"
                        ...
                        <div class="price-range__info d-flex align-items-center mt-2">
                            <div class="me-auto">
                                ...
                                <span class="price-range__min">RM10</span>
                            </div>
                            <div>
            ...
            <div class="d-flex justify-content-between mb-4 pb-md-2">
                ...
                <div
                    ...
                    <select class="shop-acs__select form-select w-auto border-0 py-0 order-1 order-md-0"
                        aria-label="Sort Items" name="sortingby" id="sortingby">
                        <option value="-1" {{$sorting == -1 ? 'selected':''}}>Default</option>
                        <option value="1" {{$sorting == 1 ? 'selected':''}}>Date, New To Old</option>
                        <option value="2" {{$sorting == 2 ? 'selected':''}}>Date, Old To New</option>
                        <option value="3" {{$sorting == 3 ? 'selected':''}}>Price, Low To High</option>
                        <option value="4" {{$sorting == 4 ? 'selected':''}}>Price, High To Low</option>
                    </select>
                                ...
                                <div class="swiper-wrapper">
                                    ...
                                    <div class="swiper-slide">
                                        ...
                                        <a href="{{route('shop.product.details', ['product_slug' => $product->slug])}}"><img
                                                loading="lazy" src="{{asset('uploads/products')}}/{{ $gimg}}"
