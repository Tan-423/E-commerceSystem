            ...
            <form class="tf-section-2 form-add-product" method="POST" enctype="multipart/form-data"
                ...
                <div class="wg-box">
                    ...
                    <div class="gap22 cols">
                        ...
                        @error('category_id')<span class="alert-danger text-center">{{ $message }}</span>@enderror
                        ...
                        @error('brand_id')<span class="alert-danger text-center">{{ $message }}</span>@enderror
                    </div>
                    ...
                    @error('short_description')<span class="alert-danger text-center">{{ $message }}</span>@enderror
                    ...
                    @error('description')<span class="alert-danger text-center">{{ $message }}</span>@enderror
                </div>
                <div class="wg-box">
                    <fieldset>
                    ...
                    @error('images')<span class="alert-danger text-center">{{ $message }}</span>@enderror
                    ...
                    <div class="cols gap22">
                        ...
                        @error('regular_price')<span class="alert-danger text-center">{{ $message }}</span>@enderror
                        <fieldset class="name">
                        ...
                        @error('sale_price')<span class="alert-danger text-center">{{ $message }}</span>@enderror
                    </div>
                    ...
                    <div class="cols gap22">
                        ...
                        @error('SKU')<span class="alert-danger text-center">{{ $message }}</span>@enderror
                        <fieldset class="name">
                        ...
                        @error('quantity')<span class="alert-danger text-center">{{ $message }}</span>@enderror
                    </div>
